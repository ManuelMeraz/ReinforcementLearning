...
class TemporalDifferenceOneAveraging(LearningAgent):
    """
    Applies the temporal difference one algorithm as a learning algorithm
    Vt+1(s) = Vt(s) + alpha * (Gt - Vt(s))
    Where alpha is the learning rate at 1/N and Gt is the sum of accumulated and discounted rewards for the episode.
